    ...
    <div class="border m-4">
      ...
      <p>カテゴリー検索</p>
        <ul>
          ...
          <ul>
            <li class="sub_categories2">
              <input type="submit" name="category_word" class="category_num{{ $sub_category->main_category_id}}"  value="{{ $sub_category->sub_category }}" form="postSearchRequest">
            </li>
          </ul>
          @endforeach
          @endforeach
